...
local errors = require("routex-client.vendor.tls13.error")
local util = require("routex-client.vendor.tls13.util")
local utilMap = require("routex-client.vendor.tls13.util.map")
local x509Alg = require("routex-client.vendor.tls13.x509.alg")

local lib = {}

-- re-exports
lib.recognizedAttributes = require("routex-client.vendor.tls13.x509.attr").recognizedAttributes
lib.recognizedExtensions = require("routex-client.vendor.tls13.x509.ext").recognizedExtensions
