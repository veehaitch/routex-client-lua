...
local aes = require("routex-client.vendor.tls13.crypto.cipher.aes")
local chacha20poly1305 = require("routex-client.vendor.tls13.crypto.cipher.chacha20-poly1305")
local gcm = require("routex-client.vendor.tls13.crypto.cipher.mode.gcm")
local group = require("routex-client.vendor.tls13.group")
local handshake = require("routex-client.vendor.tls13.handshake")
local hmac = require("routex-client.vendor.tls13.crypto.hmac")
local oid = require("routex-client.vendor.tls13.asn.oid")
local record = require("routex-client.vendor.tls13.record")
local sha2 = require("routex-client.vendor.tls13.crypto.hash.sha2")
local sigalg = require("routex-client.vendor.tls13.sigalg")
local tlsIo = require("routex-client.vendor.tls13.io")
...
local function makeOcSignatureAlgorithms()
  if require("routex-client.vendor.tls13.oc").getDataCardOrNil(3) then
    local sigalg = require("routex-client.vendor.tls13.oc.sigalg")
...
function lib.profiles.opencomputers.namedGroups()
  ...
  if require("routex-client.vendor.tls13.oc").getDataCardOrNil(3) then
    local ocGroup = require("routex-client.vendor.tls13.oc.group")
...
function lib.profiles.opencomputers.rng()
  local rng = require("routex-client.vendor.tls13.oc.rng")
...
function lib.wrap(sock, profile, options)
  ...
  return lib.wrapRaw(require("routex-client.vendor.tls13.oc.io").wrap(sock), profile, options)
end
