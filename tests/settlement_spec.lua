...
context("Key settlement #online", function ()
  ...
  test("Rejects invalid report data", function ()
    ...
    local ok, err = pcall(function () settlement:getBase64SessionId(headers) end)
    assert.is_false(ok)
